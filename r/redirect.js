...
if (url.slice(0, 11) === "javascript:") {
    ...
    if (customRedirect) url = url.replaceAll('"', '%22'); //"javascript:" + encodeURIComponent(url.slice(11));
    ...
    document.getElementById('bookmarklet-code').textContent = url; //decodeURIComponent(url);
} else {
